        ...
        <div className="px-4 py-4 mx-auto max-w-screen-xl">
          <div className="flex items-center justify-between">
            ...
            <ul className="hidden lg:flex items-center space-x-6">
              <li>
                <button className="h-12 px-6 rounded-full font-semibold text-green-900
              ...
              <li>
                <button className="text-yellow-300 font-medium hover:text-yellow-400 transition">
                  Sign in
                </button>
              </li>

              <li>
                <button className="h-12 px-6 rounded-full font-semibold text-green-950
          ...
          >
            <div className="bg-green-900 rounded-xl p-4 space-y-4 shadow-lg">
              ...
              <button className="w-full py-3 rounded-lg font-semibold text-green-900
              ...
              <button className="w-full py-3 rounded-lg font-semibold text-green-950
                bg-gradient-to-r from-yellow-500 to-yellow-300
