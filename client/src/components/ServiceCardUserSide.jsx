          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div className="flex flex-col ml-2">
                {" "}
                <div className="text-sm font-bold">{service?.duration} mins</div>
                <div className="text-sm">Video Meeting</div>
              </div>
            </div>
            <div onClick={onCardClick} className="flex items-center border border-gray-600 rounded-full group-hover:bg-black group-hover:text-white">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
